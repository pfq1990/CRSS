...
<html>
	...
	<body class="beg-login-bg">
		<div class="beg-login-box">
			...
			<div class="beg-login-main">
				<form class="layui-form">
					...
					<div class="layui-form-item">
							...
							<button class="layui-btn layui-btn-big layui-btn-primary register" onclick="return false;">
			...
			<div class="beg-login-main">
			<p class="copyright">© 2018 CHIREN Management System</p>
			</div>
		</div>
